					...
					<ul class="dropdown-menu dropdown-menu-end" aria-labelledby="clientDropdown">
						...
						<ul class="dropdown-menu dropdown-menu-end dropdown-menu-panel" aria-labelledby="panel">
							<a class="dropdown-item" href="vps-hosting#">									
								Client Area <span class="d-block">Billing &amp; Support</span>
							</a>
							<a class="dropdown-item" href="vps-hosting#">									
		...
		<div class="container-fluid container-custom">
			<div class="row">
				...
				<div class="col-lg-4 col-md-4">
					<div class="card mb-4 text-center">
						<div class="card-header py-4">
							<h2 class="mb-0">VPS PLAN 1</h2>
						</div>
						<div class="card-price py-2">
							&dollar;7.99 / <span>month</span>
						</div>
						<div class="card-body">
							<ul class="list-unstyled">
								<li><i class="fad fa-memory"></i> RAM: 8 GB</li>
								<li><i class="fad fa-hdd"></i> Storage: 25 GB NVMe</li>
								<li><i class="fad fa-microchip"></i> CPU: 2 vCPU Cores</li>
								<li><i class="fad fa-shield-alt"></i> Anti-DDoS Protection Included</li>
							</ul>
							<div class="mt-4">
								<a href="#" class="btn">Open Ticket for Order</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-4">
					<div class="card mb-4 text-center">
						<div class="card-header py-4">
							<h2 class="mb-0">VPS PLAN 2</h2>
						</div>
						<div class="card-price py-2">
							&dollar;18.99 / <span>month</span>
						</div>
						<div class="card-body">
							<ul class="list-unstyled">
								<li><i class="fad fa-memory"></i> RAM: 16 GB</li>
								<li><i class="fad fa-hdd"></i> Storage: 50 GB NVMe</li>
								<li><i class="fad fa-microchip"></i> CPU: 4 vCPU Cores</li>
								<li><i class="fad fa-shield-alt"></i> Anti-DDoS Protection Included</li>
							</ul>
							<div class="mt-4">
								<a href="#" class="btn">Open Ticket for Order</a>
				...
				<div class="col-lg-4 col-md-4">
					<div class="card mb-4 text-center">
						<div class="card-header py-4">
							<h2 class="mb-0">VPS PLAN 3</h2>
						</div>
						<div class="card-price py-2">
							&dollar;29.99 / <span>month</span>
						</div>
						<div class="card-body">
							<ul class="list-unstyled">
								<li><i class="fad fa-memory"></i> RAM: 32 GB</li>
								<li><i class="fad fa-hdd"></i> Storage: 100 GB NVMe</li>
								<li><i class="fad fa-microchip"></i> CPU: 8 vCPU Cores</li>
								<li><i class="fad fa-shield-alt"></i> Anti-DDoS Protection Included</li>
							</ul>
							<div class="mt-4">
								<a href="#" class="btn">Open Ticket for Order</a>
	...
	<!-- OS Types -->
			<div class="os pt-5">
				<div class="title text-center mb-5">
					<h4>Server Types</h4>
					<p>Choose your VPS Server type</p>
				</div>
				<div class="row">
					<div class="col-lg-6 text-center">
						<img src="assets/images/debian.svg" alt="Debian">
						<h4 class="mt-3">Debian</h4>
					</div>
					<div class="col-lg-6 text-center">
						<img src="assets/images/ubuntu.svg" alt="Ubuntu">
						<h4 class="mt-3">Ubuntu</h4>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container-fluid container-custom">
			<div class="row d-flex justify-content-between">
				<div class="col-md-5 d-flex align-items-center">
					<img src="assets/images/vps_panel.webp" class="img-fluid" alt="VPS Panel">
				</div>
				<div class="col-md-7">
