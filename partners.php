			...
			<div class="row">
				<div class="col-lg-4 col-md-4">
					<div class="card text-center">
						<img src="https://via.placeholder.com/120x120" class="partner-img rounded" alt="Partner One">
						<div class="card-body">
							<h3 class="py-3">Radisic</h3>
							<ul class="list-unstyled">
								<li><a href="partners"><i class="fab fa-discord"></i></a></li>
								<li><a href="partners"><i class="fas fa-globe"></i></a></li>
								<li><a href="partners"><i class="fab fa-instagram"></i></a></li>
							</ul>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-4">
					<div class="card text-center">
						<img src="https://via.placeholder.com/120x120" class="partner-img rounded" alt="Partner One">
						<div class="card-body">
							<h3 class="py-3">DzonY</h3>
							<ul class="list-unstyled">
								<li><a href="partners"><i class="fab fa-discord"></i></a></li>
								<li><a href="partners"><i class="fab fa-twitter"></i></a></li>
								<li><a href="partners"><i class="fab fa-twitch"></i></a></li>
							</ul>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-4">
					<div class="card text-center">
						<img src="https://via.placeholder.com/120x120" class="partner-img rounded" alt="Partner One">
						<div class="card-body">
							<h3 class="py-3">Rade</h3>
							<ul class="list-unstyled">
								<li><a href="partners"><i class="fab fa-discord"></i></a></li>
								<li><a href="partners"><i class="fab fa-youtube"></i></a></li>
								<li><a href="partners"><i class="fas fa-globe"></i></a></li>
							</ul>
						</div>
					</div>
