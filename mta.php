		...
		<div class="container-fluid container-custom">
			<div class="row">
					...
					<div class="card mb-4 text-center">
						...
						<div class="card-body">
							<ul class="list-unstyled">
								<li><i class="fad fa-users"></i> Max Players: 25</li>
							...
							<div class="mt-4">
								<a href="https://client.avoxhosting.site/index.php?rp=/store/multi-theft-auto/plan1" class="btn">Order now</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-4">
					<div class="card mb-4 text-center">
						<div class="card-header py-4">
							<h2 class="mb-0">MTA PLAN 2</h2>
						</div>
						<div class="card-price py-2">
							&dollar;2.00 / <span>month</span>
						</div>
						<div class="card-body">
							<ul class="list-unstyled">
								<li><i class="fad fa-users"></i> Max Players: 75</li>
							...
							<div class="mt-4">
								<a href="https://client.avoxhosting.site/index.php?rp=/store/multi-theft-auto/plan2" class="btn">Order now</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-4">
					<div class="card mb-4 text-center">
						<div class="card-header py-4">
							<h2 class="mb-0">MTA PLAN 3</h2>
						</div>
						<div class="card-price py-2">
							&dollar;4.00 / <span>month</span>
						</div>
						<div class="card-body">
							<ul class="list-unstyled">
								<li><i class="fad fa-users"></i> Max Players: 120</li>
							...
							<div class="mt-4">
								<a href="https://client.avoxhosting.site/index.php?rp=/store/multi-theft-auto/plan3" class="btn">Order now</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-4">
					<div class="card mb-4 text-center">
						<div class="card-header py-4">
							<h2 class="mb-0">MTA PLAN 4</h2>
						</div>
						<div class="card-price py-2">
							&dollar;6.00 / <span>month</span>
						</div>
						<div class="card-body">
							<ul class="list-unstyled">
								<li><i class="fad fa-users"></i> Max Players: 150</li>
								<li><i class="fad fa-microchip"></i> CPU Usage: Up to 250%</li>
								<li><i class="fad fa-memory"></i> RAM Usage: 4 GB</li>
								<li><i class="fad fa-hdd"></i> Storage Usage: 6 GB NVMe</li>
								<li><i class="fad fa-shield-alt"></i> Anti-DDoS Protection Included</li>
							</ul>
							<div class="mt-4">
								<a href="https://client.avoxhosting.site/index.php?rp=/store/multi-theft-auto/plan4" class="btn">Order now</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-4">
					<div class="card mb-4 text-center">
						<div class="card-header py-4">
							<h2 class="mb-0">MTA PLAN 5</h2>
						</div>
						<div class="card-price py-2">
							&dollar;8.00 / <span>month</span>
						</div>
						<div class="card-body">
							<ul class="list-unstyled">
								...
								<li><i class="fad fa-hdd"></i> Storage Usage: 8 GB NVMe</li>
								<li><i class="fad fa-shield-alt"></i> Anti-DDoS Protection Included</li>
							</ul>
							<div class="mt-4">
								<a href="https://client.avoxhosting.site/index.php?rp=/store/multi-theft-auto/plan5" class="btn">Order now</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-4">
					<div class="card mb-4 text-center">
						<div class="card-header py-4">
							<h2 class="mb-0">MTA PLAN 6</h2>
						</div>
						<div class="card-price py-2">
							&dollar;11.00 / <span>month</span>
						</div>
						<div class="card-body">
							<ul class="list-unstyled">
								...
								<li><i class="fad fa-hdd"></i> Storage Usage: 10 GB NVMe</li>
								<li><i class="fad fa-shield-alt"></i> Anti-DDoS Protection Included</li>
							</ul>
							<div class="mt-4">
								<a href="https://client.avoxhosting.site/index.php?rp=/store/multi-theft-auto/plan6" class="btn">Order now</a>
							</div>
						</div>
					</div>
				</div>
